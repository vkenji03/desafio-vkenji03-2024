...
describe('Recintos do Zoologico', () => {
    ...
    // recinto possui mais de um animal e um deles e igual ao que sera adicionado
    test('Deve encontrar recinto para 1 macaco', () => {
    ...
    // recinto possui mais de um animal e nenhum deles e igual ao que sera adicionado
    test('Deve encontrar recinto para 1 macaco', () => {
    ...
    // ANIMAIS CARNIVOROS
    // animal ja existe no recinto 
    test('Deve encontrar recinto para 1 leopardo', () => {
        const resultado = new RecintosZoo([{'leopardo': 1}, {}, {'gazela': 1}, {}, {'leao': 1}]).analisaRecintos('LEOPARDO', 1);
        expect(resultado.erro).toBeFalsy();
        expect(resultado.recintosViaveis[0]).toBe('Recinto 1 (espaço livre: 6 total: 10)');
        expect(resultado.recintosViaveis.length).toBe(1);
    });

    // animal nao existe no recinto
    test('Deve encontrar recinto para 1 leopardo', () => {
        const resultado = new RecintosZoo([{}, {}, {}, {}, {}]).analisaRecintos('LEOPARDO', 1);
        expect(resultado.erro).toBeFalsy();
